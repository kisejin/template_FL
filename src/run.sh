...
sed -i 's/folder="result_metric"/folder="result_metric2"/g' fedllm/utils.py
...
sed -i 's/folder="result_metric"/folder="result_metric3"/g' fedllm/utils.py
# Run the command again after modification
flwr run . > logs/$datetime/output.log 2> logs/$datetime/error.log
...
# Change folder parameters in utils.py to result_metric2
sed -i 's/folder="result_metric"/folder="result_metric4"/g' fedllm/utils.py
# Run the command again after modification
flwr run . > logs/$datetime/output.log 2> logs/$datetime/error.log